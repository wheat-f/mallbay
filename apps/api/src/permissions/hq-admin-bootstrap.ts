...
export const HEADQUARTERS_ADMIN_GRANTS = [
  ...
  ["finance", "read", "GLOBAL"], ["finance", "write", "GLOBAL"], ["finance.cost", "read", "GLOBAL"],
  ...
  ["rebates", "read", "GLOBAL"], ["rebates", "review", "GLOBAL"], ["rebates", "pay", "GLOBAL"],
  ["commissions", "write", "GLOBAL"],
  ["returns", "write", "GLOBAL"], ["returns", "create", "GLOBAL"], ["returns", "manage", "GLOBAL"], ["returns", "approve", "GLOBAL"], ["returns", "finance", "GLOBAL"],
