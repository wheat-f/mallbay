...
export const PERMISSION_CATALOG: readonly PermissionCatalogEntry[] = [
  ...
  { code: "settings.audit.store", name: "门店审计", resource: "settings", actions: ["read"], supportedScopes: STORE },
...
export const SETTINGS_CAPABILITY_PERMISSION: Record<string, { permissionCode: string; actionBySettingsAction: Record<string, string> }> = {
  ...
  "settings.audit.store": { permissionCode: "settings.audit.store", actionBySettingsAction: { view: "read", audit: "read" } },
