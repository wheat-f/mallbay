...
const PATHS: Record<string, string> = {
  ...
  "settings.permissions": "/settings/permissions", "settings.dictionary": "/settings/dictionaries", "settings.security": "/settings/security", "customer.tags": "/settings/customer-tags", "settings.audit.global": "/settings/audit", "settings.audit.store": "/settings/audit",
