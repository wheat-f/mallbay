...
export default function FinanceSettingsPage() {
  ...
  if (!storeId || loading) return <div className="management-page"><Spin description="正在加载财务配置…" /></div>;
