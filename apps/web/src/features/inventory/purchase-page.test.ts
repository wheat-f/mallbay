...
test("purchase requirement table uses source order business labels in the purchase domain", () => {
...
test("purchase requirement table shows product demand summary instead of requirement ids", () => {
  const requirementsSource = readFileSync("app/purchases/requirements/page.tsx", "utf8");
