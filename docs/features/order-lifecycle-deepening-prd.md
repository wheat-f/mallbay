...
| QA-001 | Web 代表页面 live 检查、1440/1024/390 响应式与浏览器证据 | 已完成 | 已登录店长真实验收工作台、订单详情、已完工施工详情和客户详情；北京测试门店订单数 2、待派单 1、已收款 ¥2,950；订单 `cmrlk0f6k0002e4t7noucz70v`、施工记录 `cmr7ojigq0000y8t785oy8wjx`、客户 `cmrkpk1090003tgt781xbw3f5` 的关键数据均可见；1440/1024/390 三种视口下代表页面 `scrollWidth <= viewportWidth`，页面控制台无应用错误；客户消费记录 ¥3,800 和人工标签入口均可见；Web typecheck/build 已通过 |
